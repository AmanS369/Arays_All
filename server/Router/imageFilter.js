...
import { bwFilterController, MPLController,converterController, grayscaleController, invertFilterController } from '../Controller/FilterController.js';
...
router.post('/mpl',upload.single('image'),MPLController)
